...
Sub set_api_key()
    ...
    Else
        ...
        MsgBox "API Key verified", Title:="Set API Key"
...
Sub taxonomy()
    ...
    Else
        ...
        For Each category In response.Data("categories")
            ...
            'Add values to allow a sort field to put empty values first when sorting
            If Cells(i, 4) = "" Then
    ...
    With ActiveWindow
        ...
        .SplitRow = 1
    End With
    Range("A1:K1").Cells.Font.Bold = True
    ' Set the width of the columns
    ...
    With ActiveSheet.Sort
        ...
        .SortFields.Add key:=Range("N1"), Order:=xlAscending
    ...
    ActiveSheet.Columns("L:N").Delete
